...
const AP_Param::GroupInfo AE_RobotArmInfo::var_info[] = {
    ...
    // @User: Advanced
    // @Units: mm
    AP_GROUPINFO("CLD1_BM_MX",    2, AE_RobotArmInfo, excavtor_param._boom_cylinder_max, 0),
    ...
    // @User: Advanced
    // @Units: mm
    AP_GROUPINFO("CLD2_FM_MX",    3, AE_RobotArmInfo, excavtor_param._forearm_cylinder_max, 0),
    ...
    // @User: Advanced
    // @Units: mm
    AP_GROUPINFO("CLD3_BK_MX",    4, AE_RobotArmInfo, excavtor_param._bucket_cylinder_max, 0),
